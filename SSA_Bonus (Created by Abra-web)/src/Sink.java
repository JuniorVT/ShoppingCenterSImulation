...
public class Sink implements ProductAcceptor
{
	...
	private ArrayList<Boolean> serviceDesk;
	...
	*/
	...
	public boolean giveProduct(Product p)
	{
		...
		for(int i=0;i<t.size();i++)
		{
			...
			serviceDesk.add(p.getServiceDesk());
		}
		return true;
	}
	...
	public boolean[] getServiceDesk()
	{
		serviceDesk.trimToSize();
		boolean[] tmp = new boolean[serviceDesk.size()];
		for (int i=0; i < serviceDesk.size(); i++)
		{
			tmp[i] = (serviceDesk.get(i)).booleanValue();
		}
		return tmp;
	}
}